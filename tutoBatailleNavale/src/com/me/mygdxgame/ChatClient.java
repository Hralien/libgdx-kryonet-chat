...
import com.me.mygdxgame.Network.ChatMessage;
import com.me.mygdxgame.Network.RegisterName;
import com.me.mygdxgame.Network.UpdateNames;
...
//		name = input.trim();
	...
	public static class ChatWindow{
		...
		public ChatWindow(String host){
			...
			window.row();
			window.add(splitPane).minWidth(600).expandX().fillX().minHeight(100);
			window.row();
